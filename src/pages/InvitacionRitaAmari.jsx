...
export default function InvitacionRitaAmari() {
    ...
    // (A) Mantener sincronizado el estado "muted" con el elemento <audio>
    useEffect(() => {
    ...
    // (1) Intentar reproducir al cargar (puede ser bloqueado por el navegador)
    useEffect(() => {
        const a = audioRef.current;
        if (!a) return;
        ...
        const tryPlay = async () => {
            try {
                ...
                // Autoplay bloqueado: se activará con el primer toque
                setIsPlaying(false);
            }
        };
    ...
    // (2) Fallback: primer toque/click habilita sonido si autoplay fue bloqueado
    useEffect(() => {
    ...
    // (3) Pausar si cambia de pestaña/app y reanudar al volver + pagehide (mejor en móvil/iOS)
    useEffect(() => {
        const a = audioRef.current;
        if (!a) return;
        ...
        <div className="relative w-full min-h-[100svh] overflow-x-hidden bg-[#07162f]">
            ...
            <div className="relative z-10 w-full flex justify-center px-3 py-6">
                <div className="w-full max-w-[430px]">
                    {/* Audio */}
                    <audio ref={audioRef} src="/audio/bella-y-bestia.mp3" loop preload="auto" />
                            ...
                            <div className="relative mt-4">
                                ...
                                >
                                    <div
                                        ...
                                        style={{
                                            background: "linear-gradient(180deg, #E7D08B 0%, #C8A24A 45%, #9A7427 100%)",
